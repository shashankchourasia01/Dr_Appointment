...
const HeroSection = () => {
  ...
  <div className="absolute inset-0 bg-gradient-to-t from-blue-900/20 to-transparent"></div>
          ...
          <div className="w-full md:flex-1 text-center md:text-left">
            ...
            {/* Stats */}
            {/* <div className="flex gap-4 md:gap-6 mt-6 md:mt-8 justify-center md:justify-start">
              <div>
                <p className="text-lg md:text-2xl font-bold text-gray-900">15+</p>
                <p className="text-xs md:text-sm text-gray-500">Years Exp.</p>
              </div>
              <div>
                <p className="text-lg md:text-2xl font-bold text-gray-900">5k+</p>
                <p className="text-xs md:text-sm text-gray-500">Patients</p>
              </div>
              <div>
                <p className="text-lg md:text-2xl font-bold text-yellow-500">4.9</p>
